...
public:
    ...
    void setupUi(QMainWindow *SimpleTextEditClass)
    {
        ...
        SimpleTextEditClass->setWindowModality(Qt::ApplicationModal);
        SimpleTextEditClass->resize(802, 679);
        QSizePolicy sizePolicy(QSizePolicy::Maximum, QSizePolicy::Maximum);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(SimpleTextEditClass->sizePolicy().hasHeightForWidth());
        SimpleTextEditClass->setSizePolicy(sizePolicy);
        SimpleTextEditClass->setBaseSize(QSize(1920, 1080));
